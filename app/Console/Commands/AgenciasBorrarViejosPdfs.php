...
class AgenciasBorrarViejosPdfs extends Command
{
    protected $signature = 'pdfs:agencias-borrar-viejos';
    protected $description = 'Borra los archivos PDF del mes que está 3 meses atrás desde la fecha actual (carpeta agencies).';
    ...
    public function handle()
    {
        try {
            ...
            $logMessage = "🧹 [pdfs:agencias-borrar-viejos] Ejecutado el {$now->toDateTimeString()}\n"
                . "Carpeta: {$directory}\n"
            ...
            Log::build([
                'driver' => 'single',
                'path' => storage_path('logs/agencies_pdf_cleanup.log'),
            ])->error("[pdfs:agencias-borrar-viejos] Error: " . $e->getMessage());
