                ...
                [
                    ...
                    "translables" =>  [
                        [
                            #ESPAÑOL
                            "lenguage_id" =>  "1",
                            "name"        =>  "<p>19 Julio al 31 Mayo</p>",
                            "description" =>  "<p>La disponibilidad de esta excursión es del 19 de Julio al 31 de Mayo</p>"
                        ],
                        [
                            # INGLES
                            "lenguage_id" =>  "2",
                            "name"        =>  "<p>July 19th to May 31th</p>",
                            "description" =>  "<p>The availability of this excursion is from July 19 to May 31</p>"
                        ],
                        [
                            # PORTUGUÉS
                            "lenguage_id" =>  "3",
                            "name"        =>  "<p>19 Julho até 31 maio</p>",
                            "description" =>  "<p>A disponibilidade desta excursão é de 19 de Julho a 31 de Mayo</p>"
                        ]
                    ]
                ],
                #$bus
                    ...
                    [
                        ...
                        "translables" => [
                            [
                                "lenguage_id" => 1,
                                "name" => null,
                                "description" => "<p>Vestir ropa c&oacute;moda y abrigada. Campera&nbsp;y&nbsp;pantal&oacute;n impermeable,&nbsp;calzado deportivo o&nbsp;botas de&nbsp;trekking&nbsp;impermeables.&nbsp;El clima es cambiante y hay que estar preparado para no mojarse ni pasar fr&iacute;o.&nbsp;Lentes de sol, protector solar, guantes, gorro, mochila.</p>"
                            ],
                            [
                                "lenguage_id" => 2,
                                "name" => null,
                                "description" => "<p>Wear comfortable and warm clothes. A jacket, sports shoes or trekking boots, sunglasses, sunscreen, gloves, a wool hat and a backpack.</p>"
                            ],
                            [
                                "lenguage_id" => 3,
                                "name" => null,
                                "description" => "<p>Roupa confort&aacute;vel e quente. Casaco, cal&ccedil;ado esportivo ou botas de trekking, &oacute;culos de sol, protetor solar, luvas, gorro e mochila.</p>"
                            ]
                        ]
                    ],
                    [
                ...
                [
                    ...
                    "translables" =>  [
                        [
                            #ESPAÑOL
                            "lenguage_id" =>  "1",
                            "name"        =>  "<p>15 Agosto al 30 Abril</p>",
                            "description" =>  "<p>La disponibilidad de esta excursión es del 15 de Agosto al 30 de Abril</p>"
                        ],
                        [
                            # INGLES
                            "lenguage_id" =>  "2",
                            "name"        =>  "<p>August 15th to April 30th</p>",
                            "description" =>  "<p>It is available from August 15 until the end of April</p>"
                        ],
                        [
                            # PORTUGUÉS
                            "lenguage_id" =>  "3",
                            "name"        =>  "<p>15 agosto até 30 abril</p>",
                            "description" =>  "<p>A excursão é disponível a partir do 15º dia de agosto até o fim de abril</p>"
                        ]
                    ]
                ],
                #$bus
                    ...
                    [
                        ...
                        "translables" => [
                            [
                                "lenguage_id" => 1,
                                "name" => null,
                                "description" => "<p>Vestir ropa cómoda y abrigada. Campera y pantalón impermeable, calzado deportivo o botas de trekking impermeables. El clima es cambiante y hay que estar preparado para no mojarse ni pasar frío. Lentes de sol, protector solar, guantes, gorro y mochila.</p>"
                            ],
                            [
                                "lenguage_id" => 2,
                                "name" => null,
                                "description" => "<p>Wear comfortable and warm clothes. A rain jacket, long waterproof trousers, trekking boots, a medium-size backpack (40Lts), sunglasses, sunscreen, gloves, a wool hat and a backpack.</p>"
                            ],
                            [
                                "lenguage_id" => 3,
                                "name" => null,
                                "description" => "<p>Vestir roupa confort&aacute;vel e quente. Casaco imperme&aacute;vel, cal&ccedil;as cumpridas e imperme&aacute;veis, botasde trekking imperme&aacute;veis, mochila m&eacute;dia (40 litros), &oacute;culosde sol, protetor solar, luvas, gorro e mochila.</p>"
                            ]
                        ]
                    ],
                    [
                    ...
                    [
                        ...
                        "translables" => [
                            [
                                "lenguage_id" => 1,
                                "name" => null,
                                "description" => "<p>Deberás presentar tu entrada al Parque Nacional. Podés comprarla <span class='text-primary'>acá (Seleccionar: 'Acceso Corredor Rio Mitre y Glaciar Perito Moreno')</span> o abonarla en efectivo (en pesos argentinos) al llegar al Parque Nacional Los Glaciares.</p>"
                            ],
                            [
                                "lenguage_id" => 2,
                                "name" => null,
                ...
                [
                    ...
                    "translables" =>  [
                        ...
                        [
                            # INGLES
                            "lenguage_id" =>  "2",
                            "name"        =>  "<p>19 july to 31 may</p>",
                            "description" =>  "<p>The availability of this excursion is from July 19 to May 31</p>"
                        ],
                        [
                            # PORTUGUÉS
                            "lenguage_id" =>  "3",
                            "name"        =>  "<p>19 de julho a 31 de maio</p>",
                            "description" =>  "<p>A disponibilidade desta excursão é de 19 de julho a 31 de maio</p>"
                        ]
                    ]
                ],
                #$bus
                    ...
                    "characteristics" => [
                        ...
                        [
                            ...
                            "translables" => [
                                ...
                                [
                                    "lenguage_id" => 2,
                                    "name" => "Walking along the coast and being close to the glacier",
                                    "description" => null
                                ],
                                [
                                    "lenguage_id" => 3,
                    ...
                    [
                        ...
                        "translables" => [
                            [
                                "lenguage_id" => 1,
                                "name" => null,
                                "description" => '<p>Deber&aacute;s presentar tu entrada al Parque Nacional. Pod&eacute;s comprarla&nbsp;<span style="color: rgb(36, 113, 185);"><a style="color: rgb(36, 113, 185);" href="https://ventaweb.apn.gob.ar/reserva/inicio?dp=05" target="_blank" rel="noopener"><strong>ac&aacute; (Seleccionar: &ldquo;Acceso Corredor Rio Mitre y Glaciar Perito Moreno&rdquo;)</strong></a>&nbsp;</span>o abonarla en efectivo (en pesos argentinos) al llegar al Parque Nacional Los Glaciares.</p>'
                            ],
                            [
                                "lenguage_id" => 2,
                                "name" => null,
                    ...
                    [
                        ...
                        "translables" => [
                            [
                                "lenguage_id" => 1,
                                "name" => null,
                                "description" => '<p>Deber&aacute;s presentar tu entrada al Parque Nacional. Pod&eacute;s comprarla&nbsp;<a href="https://ventaweb.apn.gob.ar/reserva/inicio?dp=05" target="_blank" rel="noopener"><strong>ac&aacute;<span style="color: #2471B9;"> (Seleccionar: &ldquo;Acceso Corredor Rio Mitre y Glaciar Perito Moreno&rdquo;)</span></strong></a>&nbsp;o abonarla en efectivo (en pesos argentinos) al llegar al Parque Nacional Los Glaciares.</p>'
                            ],
                            [
                                "lenguage_id" => 2,
                                "name" => null,
