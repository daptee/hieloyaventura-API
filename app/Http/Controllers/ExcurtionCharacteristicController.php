...
class ExcurtionCharacteristicController extends Controller
{
    ...
    // public function minitrekking2($request) // convert json to array IMPORTANT
 // {
    //     $characteristics = [];
    ...
    //             # translables
    //             "translables" => $request->characteristics['translables'], // Array translables
    //             // "translables" => [
    //             //         [
    //             //             "lenguage_id" =>  1,
    //             //             "name" =>  "Característica de la actividad",
    ...
    //             # Las 6 características o ḿas
    //             #Translables
    //             // "characteristics" => $request->characteristics['characteristics'], // CHEQUEAR CON SEBA
    //             "characteristics" =>
    //             [
    //                 #$clock
    //                     [
    ...
    //                 "characteristics" => [],
    //                 "translables" => $request->about['translables'], // Array translables
    //                 // "translables" => [
    //                 //     [
    //                 //         "lenguage_id" => 1,
    //                 //         "name" => "Sobre esta experiencia",
    ...
    //                     "icon" => null,
    //                     "order" => null,
    //                     // "characteristics" => $request->before_buying['characteristics'],
    //                     "characteristics" => [
    //                         [
    //                             "id" => 6567,
    //                             "icon_id" => null,
    ...
    //             //     ]
    //             // ],
    //             "characteristics" => $request->itinerary['characteristics'],
    //             "translables" => $request->itinerary['translables'],
    //             // "translables" => [
    //             //     [
    //             //         "lenguage_id" => 1,
    //             //         "name" => "Itinerario Minitrekking",
    ...
    //                 "order" => null,
    //                 "icon" => null,
    //                 "characteristics" => $request->carry['characteristics'],
    //                 "translables" => $request->carry['translables'],
    //                 // "characteristics" => [
    //                 //     [
    //                 //         "icon_id" => null,
    //                 //         "order" => null,
