...
Route::get('/agency/hya/Agencias', [AgencyUserController::class, 'agencies'])->middleware(['jwt.verify']);
Route::get('/agency/hya/Productos', [AgencyUserController::class, 'products'])->middleware(['jwt.verify']);
Route::get('/agency/hya/TiposPasajeros', [AgencyUserController::class, 'passenger_types'])->middleware(['jwt.verify']);
Route::get('/agency/hya/Naciones', [AgencyUserController::class, 'nationalities'])->middleware('jwt.verify');
Route::get('/agency/hya/Hoteles', [AgencyUserController::class, 'hotels'])->middleware('jwt.verify');
Route::get('/agency/hya/Turnos', [AgencyUserController::class, 'shifts'])->middleware('jwt.verify');
Route::post('/agency/hya/IniciaReserva', [AgencyUserController::class, 'start_reservation'])->middleware('jwt.verify');
Route::post('/agency/hya/CancelaReserva', [AgencyUserController::class, 'cancel_reservation'])->middleware('jwt.verify');
